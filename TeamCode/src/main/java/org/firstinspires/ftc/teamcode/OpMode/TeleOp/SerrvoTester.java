...
import static org.firstinspires.ftc.teamcode.RobotComponents.feetech_servo;
...
@TeleOp( name = "Servo Test / Drive OP")
public class SerrvoTester extends OpMode {
    private Input input;
